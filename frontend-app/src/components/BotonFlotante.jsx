...
export const BotonFlotante = () => {
    ...
    const toggleSize = () => {
        setSize(prevSize => ({
            ...
            height: prevSize.height === '12vh' ? '90vh' : '12vh',
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between  bg-red-400 h-0 mb-20">
                ...
                <div>
                    <button className="hover:scale-110  transition-all   h-20" onClick={toggleSize} onMouseEnter={() => handleMouseEnter(isExpanded ? "Cerrar" : "Agregar una mascota")} onMouseLeave={handleMouseLeave} >
                    {isExpanded ? (
                            <IoCloseSharp className="text-orange transition-all ml-[15px]" style={{ marginBottom: size.marginBottom }} mensaje="Agergar una mascota" />
                        ) : (
                ...
                <div className="">
                    ...
                    >
                        <button className="hover:scale-110  h-20 transition-all" onMouseEnter={() => handleMouseEnter("Enviar mensaje")} onMouseLeave={handleMouseLeave}>
            ...
            {showTitle && (
                <div className={`border-2 border-orange text-[20px] flex justify-center items-center p-3 absolute w-56 right-[8px] rounded-2xl bg-Blue text-orange transition-all duration-30000
                ${isExpanded ?  "bottom-[82vh] right-[10px]" :  "bottom-32"}
                `} >
                    <h1 >{showTitle}</h1>
                </div>
            )}
