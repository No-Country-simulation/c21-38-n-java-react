...
export const Mascota = ({pet, reverse}: Props) => {
    ...
    return (
        <section
            className={`w-[65%] h-auto justify-center items-center flex gap-40  pt-20 pb-20 mb-1 p-10  border-t-2 ${reverse == true ? "flex-col lg:flex-row" : "flex-col lg:flex-row-reverse"}`}>
