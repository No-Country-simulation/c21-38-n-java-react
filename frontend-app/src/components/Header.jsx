    ...
    return(
        <header className="flex-col justify-center items-center"> 
            <div className="flex-col justify-center items-center relative">
                ...
                <p className="absolute w-[64%] bottom-[87px] right-20 text-xl text-justify lg:text-3xl md:text-2xl transition-all duration-500 lg:w-[33.8%] text-[#F8F9FA] mr-[106px]"
